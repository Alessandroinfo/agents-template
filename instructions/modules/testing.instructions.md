...
- Define test levels (unit/integration/e2e), coverage threshold, and required tools.
- Locator standards (e.g., Testing Library `getByRole`/`getByTestId`, Playwright `getByRole`).
- CI artifacts on failure (screenshots/video for e2e).
