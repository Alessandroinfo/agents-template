...
- Provide a directory map and what belongs where.
- Define architectural style (Clean/Hex/Layered), state management, and **dependency boundaries**.
- UI rule: all text goes through the chosen **i18n tool**; define key namespaces.
- Add import rules (“X may import Y, but not Z”).
