...
# Versioning & Branching – Instructions
...
- Pick branch model (**Trunk-Based** or **Gitflow**).
- State that even bugfixes/hotfixes start from a **new branch**.
- Provide **naming conventions** for feature/bugfix/hotfix/release.
- List protected branches and merge rules (e.g., mandatory human review).
