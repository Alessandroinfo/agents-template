...
- Project type: **Enterprise** (stability/compliance) or **Solo** (experimentation/iteration).
- State business goals, primary components, and key constraints.
- List actor personas (dev/ops/analyst/end-user) if helpful.
